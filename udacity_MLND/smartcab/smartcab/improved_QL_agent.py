...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        maxQ = max([self.Q[self.state][a] for a in self.valid_actions])
    ...
    def choose_action(self, state):
        ...
        if self.learning is True:
            if random_switch > self.epsilon: # the 'exploit' part of the Q-learning
                ...
                action = random.choice(best_actions.keys()) # randomly select between equally good choices
            else: # the 'explore' part of Q-learning
